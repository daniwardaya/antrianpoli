...
class PasienPoliRehabilitasiMedikController extends Controller
{
    public function dataAntrianRehabilitasiMedik(){
        $today = Carbon::now()->format('Y-m-d');
        
        $dataAntrianRehabilitasiMedik = DB::table('reg_periksa')
        ...
        return DataTables::of($dataAntrianRehabilitasiMedik)
            ->make(true);
    }
    
    public function panggilAntrianRehabilitasiMedik(Request $request)
    {
        $today = Carbon::now()->format('Y-m-d');
    ...
    public function selesaiAntrianRehabilitasiMedik(Request $request){
        $no_reg = $request->input('no_reg');
        $kd_poli = $request->input('kd_poli');
        $nama_dokter = $request->input('nama');
        $status = 'selesai';
    ...
    public function dashboardRehabilitasiMedik(){

        return view('dashboard.dashboardRehabilitasiMedik',[

            'nama_poli' => 'POLIKLINIK REHABILITASI MEDIK',
        ]);
    }
    public function dashboardRehabilitasiMedik2(){
    ...
    public function getAntrianRehabilitasiMedik()
    {
