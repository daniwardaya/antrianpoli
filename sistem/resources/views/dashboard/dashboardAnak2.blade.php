...
@section('nomor_antrian')
    <div class="row" style="margin-top: 250px; color: white;">
        <div class="column">
            <img src="img/dokter/dr-irene.png" alt="logo dokter" style="width: 600px;  ">
    ...
    <script>
        ...
        function suaraAntrian(noAntrian) {
            var message = "Nomor Antrian " + noAntrian + " Menuju kepoli Anak dokter Iren Aurelia Santoso S P A";
            speak(message);
        }

        function updateAntrianInfo() {
            $.ajax({
                "url": "{{ route('getAntrianAnak2') }}",
                "dataType": "json",
                "type": "GET",
