...
@section('nomor_antrian')
    <div class="row" style="margin-top: 250px; color: white;">
        <div class="column">
            <img src="img/dokter/dr-ocin.png" alt="logo dokter" style="width: 600px;  ">
    ...
    <script>
        ...
        function suaraAntrian(noAntrian) {
            var message = "Nomor Antrian " + noAntrian + " Menuju kepoli Bedah dokter Ocin Sei S P B";
            speak(message);
        }

        function updateAntrianInfo() {
            $.ajax({
                "url": "{{ route('getAntrianBedah3') }}",
                "dataType": "json",
                "type": "GET",
