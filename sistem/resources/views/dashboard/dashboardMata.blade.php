...
@section('nomor_antrian')
    <div class="row" style="margin-top: 250px; color: white;">
        <div class="column">
            <img src="img/dokter/dr-rama.png" alt="logo dokter" style="width: 600px;  ">
    ...
    <script>
        ...
        function suaraAntrian(noAntrian) {
            var message = "Nomor Antrian " + noAntrian + " Menuju kepoli Mata dokter Rama Nurahmayana S P M";
            speak(message);
        }

        function updateAntrianInfo() {
            $.ajax({
                "url": "{{ route('getAntrianMata') }}",
                "dataType": "json",
                "type": "GET",
