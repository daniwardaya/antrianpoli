...
@section('nomor_antrian')
    <div class="row" style="margin-top: 250px; color: white;">
        <div class="column">
            <img src="img/dokter/dr-johan.png" alt="logo dokter" style="width: 600px;  ">
    ...
    <script>
        ...
        function suaraAntrian(noAntrian) {
            var message = "Nomor Antrian " + noAntrian + " Menuju kepoli Kandungan dokter Johan Taruna SPOG";
            speak(message);
        }

        function updateAntrianInfo() {
            $.ajax({
                "url": "{{ route('getAntrianObgin') }}",
                "dataType": "json",
                "type": "GET",
