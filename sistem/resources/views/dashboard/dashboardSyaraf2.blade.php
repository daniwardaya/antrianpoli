...
@section('nomor_antrian')
    <div class="row" style="margin-top: 250px; color: white;">
        <div class="column">
            <img src="img/dokter/dr-indah.png" alt="logo dokter" style="width: 600px;  ">
    ...
    <script>
        ...
        function suaraAntrian(noAntrian) {
            var message = "Nomor Antrian " + noAntrian + " Menuju kepoli syaraf dokter Indah Aprilia S P N M kes";
            speak(message);
        }

        function updateAntrianInfo() {
            $.ajax({
                "url": "{{ route('getAntrianSyaraf2') }}",
                "dataType": "json",
                "type": "GET",
